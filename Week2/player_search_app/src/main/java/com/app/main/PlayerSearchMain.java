		...
		do {
			...
			case 2:
				...
				try {
					...
					//code to service 
					Player player=playerSearchService.getPlayerById(jersey_no);
					if (player!=null) {
			...
			case 6:
				...
				try {
					...
					if(PlayersDOBList!=null && PlayersDOBList.size()>0) {
						System.out.println("There are "+PlayersDOBList.size()+" no of player/s.. with Date of Birth "+dob+" Printing their details......");
