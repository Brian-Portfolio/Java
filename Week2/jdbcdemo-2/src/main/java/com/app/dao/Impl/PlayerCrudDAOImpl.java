...
public class PlayerCrudDAOImpl implements PlayerCrudDao{
	...
	public int createPLayer(Player player) throws BusinessException {
		...
		try(Connection connection=PostresqlConnection.getConnection()){
			String sql = "insert into test.player(player_id, player_name, team_id, player_age, state_id, jersey_no, manager_id, position_id, player_gender, dob) values (?,?,?,?,? ,?,?,?,?,?::date)";
			...
			preparedStatement.setString(10, player.getDob());
